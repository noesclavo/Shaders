...
uniform sampler2D adsk_results_pass5;   // Premultiplied Input
uniform sampler2D adsk_results_pass6;   // Output of horizontal blur execution pass (the first pass);;             
...
void main(void) {
    ...
    if (e) {
        ...
        gl_FragColor = blur(adsk_results_pass6, eblur, e);
    }
}
