...
#define pass1 adsk_results_pass1
#define pass2 adsk_results_pass2

uniform sampler2D pass1;        // Premultiplied Input
...
void main(void) {
    ...
    if (passes == 1) {
        ...
        blurred = blur(adsk_results_pass1, eblur, e);
    } else if (adsk_result_execution == 1) {
        blurred = blur(adsk_results_pass2, eblur, e);
    }
