...
#define PreMult adsk_results_pass8
...
vec4 blur()
{
    ...
    float bme = pow(blur_amount, 3.0);

    float br = blur_red * bme * bias * strength;
    float bg = blur_green * bme * bias * strength;
    float bb = blur_blue * bme * bias * strength;
    float bm = blur_matte * bme * bias * strength;
